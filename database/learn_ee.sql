...
INSERT INTO `exp_security_hashes` (`hash_id`, `date`, `session_id`, `hash`) VALUES 
	...
	(6, 1605721151, '77f670ef7ecdf603d6b5e341d45f4f1904a1392b', 'd834b6befa560b3a9717324ca51a1b890a80ff80');
...
INSERT INTO `exp_sessions` (`session_id`, `member_id`, `admin_sess`, `ip_address`, `user_agent`, `login_state`, `fingerprint`, `sess_start`, `auth_timeout`, `last_activity`, `can_debug`) VALUES 
	('77f670ef7ecdf603d6b5e341d45f4f1904a1392b', 1, 1, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.111 Safari/537.36', NULL, '93ce595b17f9bdc5fae4aeb7c206742e', 1605728959, 0, 1605728959, '0');
...
--
-- Database backup completed by ExpressionEngine on 2020-11-18 02:49:19EST
--
