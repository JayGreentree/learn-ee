...
INSERT INTO `exp_security_hashes` (`hash_id`, `date`, `session_id`, `hash`) VALUES 
	...
	(12, 1606158165, 'b28ff49a0e0e6b4127766d64414cb3a80c6ff108', 'c87f6f027523fb5ef86d4c1ef6e855712281fbdd');
...
INSERT INTO `exp_sessions` (`session_id`, `member_id`, `admin_sess`, `ip_address`, `user_agent`, `login_state`, `fingerprint`, `sess_start`, `auth_timeout`, `last_activity`, `can_debug`) VALUES 
	('b28ff49a0e0e6b4127766d64414cb3a80c6ff108', 1, 1, '127.0.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.111 Safari/537.36', NULL, '93ce595b17f9bdc5fae4aeb7c206742e', 1606158165, 0, 1606159132, '0');
...
--
-- Database backup completed by ExpressionEngine on 2020-11-23 02:18:52EST
--
